...
# Direct Render
    ...
    #Signup Process
     ...
     path("invoice_sub_pdff/<int:key>",views.Invoice_Sub_Pdff,name="invoice_sub_pdff"),
...
# Views Links (Not callable)
   ...
   #Admin
     ...
     path("verify_rc_profile/",views.Verify_Rc_Profile,name="verify_rc_profile"),
     ...
     path("sc_profiles/",views.Sc_Profiles,name="sc_profiles"),
     path("rc_profiles/",views.Rc_Profiles,name="rc_profiles"),
