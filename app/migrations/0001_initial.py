# Generated by Django 2.0 on 2021-04-10 06:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='RC_Scrap_Request_detail',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Scrap_Name', models.CharField(blank=True, max_length=30, null=True)),
                ('Quantity', models.IntegerField()),
                ('RC_Scrap_Request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.RC_Scrap_Request')),
            ],
        ),
        migrations.CreateModel(
            name='SC',
